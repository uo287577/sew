        ...
        <section>
            ...
            <?php 
                ...
                if($_FILES) // solo se ejecutará si se han enviado ficheros
                {
                    if(isset($_POST["Cargar_era_1"]))
                    {
                        ...
                        if($era -> getNombreFicheroCorrespondienteALaEra($numeroEra) === $ficheroCSV)
                        {
                            $era -> importarEra($ficheroCSV, $era -> getNombreEra($numeroEra));
            ...
            <?php
                ...
                if (isset($_POST["Exportar_era_1"]) && isset($_SESSION['tabla1']))
                {
                    ...
                    echo "<p>Datos exportados a " . $era -> getNombreEra($numeroEra) . "_exported.csv" . ".</p>";
                }
            ?>
        </section>
