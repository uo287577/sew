        ...
        <section>
            ...
            <section>
                ...
                <form action='#' method='POST' enctype="multipart/form-data">
                    ...
                    <input type='submit' value='Cargar' name='Cargar_era_1' >
                </form>
            </section>
        </section>
        ...
        <section>
            ...
            <section>
                ...
                <form action='#' method='POST' enctype="multipart/form-data">
                    ...
                    <input type='submit' value='Cargar' name='Cargar_era_2' >
                </form>
            </section>
        </section>
        ...
        <section>
            ...
            <section>
                ...
                <form action='#' method='POST' enctype="multipart/form-data">
                    ...
                    <input type='submit' value='Cargar' name='Cargar_era_3' >
                </form>
            </section>
        </section>
        ...
        <section>
            ...
            <section>
                ...
                <form action='#' method='POST' enctype="multipart/form-data">
                    ...
                    <input type='submit' value='Cargar' name='Cargar_era_4' >
                </form>
            </section>
        </section>
        ...
        <section>
            ...
            <section>
                ...
                <form action='#' method='POST' enctype="multipart/form-data">
                    ...
                    <input type='submit' value='Cargar' name='Cargar_era_5' >
                </form>
            </section>
        </section>
