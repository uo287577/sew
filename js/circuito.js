...
class Circuito
{
    ...
    {
        document.querySelector("article:nth-of-type(1) > label:nth-of-type(1) > input").setAttribute("disabled","true");
    }

    deshabilitarCargaDeFicheroKML()
    {
        document.querySelector("article:nth-of-type(1) > label:nth-of-type(2) > input").setAttribute("disabled","true");
    }

    deshabilitarCargaDeFicheroSVG()
    {
        document.querySelector("article:nth-of-type(1) > label:nth-of-type(3) > input").setAttribute("disabled","true");
    }
    ...
    cargarXML(files)
    {
        ...
        var archivo = document.querySelector("article:nth-of-type(1) > label:nth-of-type(1) > input").files[0];
        ...
        if(archivo.type.match(tipoXML))
        {
            ...
            var seccionCampos = $("main > section:nth-of-type(1)", document.body); // seleccionamos del body del HTML el elemento del query selector

            $("p:nth-of-type(1)", seccionCampos).text("Nombre del archivo: " + archivo.name); // seleccionamos el elemento de la seccion y le asignamos el texto
		    $("p:nth-of-type(2)", seccionCampos).text("Tamaño del archivo: " + archivo.size + " bytes"); // seleccionamos el elemento de la seccion y le asignamos el texto
		    $("p:nth-of-type(3)", seccionCampos).text("Tipo del archivo: " + archivo.type); // seleccionamos el elemento de la seccion y le asignamos el texto
		    $("p:nth-of-type(4)", seccionCampos).text("Fecha de la última modificación: " + archivo.lastModifiedDate); // seleccionamos el elemento de la seccion y le asignamos el texto
		    $("p:nth-of-type(5)", seccionCampos).text("Contenido del archivo de texto:"); // seleccionamos el elemento de la seccion y le asignamos el texto
    ...
    cargarKML(files)
    {
		...
		//Solamente toma un archivo
		//var archivo = document.getElementById("archivoTexto").files[0];
        var archivo = document.querySelector("article:nth-of-type(1) > label:nth-of-type(2) > input").files[0];
    ...
    cargarSVG(files)
    {
		...
		//Solamente toma un archivo
		//var archivo = document.getElementById("archivoTexto").files[0];
        var archivo = document.querySelector("article:nth-of-type(1) > label:nth-of-type(3) > input").files[0];
