...
class Circuito
{
    ...
    cargarXML(files)
    {
        ...
        if(archivo.type.match(tipoXML))
        {
            ...
            var seccionCampos = document.querySelector("main > section:last-of-type");

            document.querySelector(seccionCampos + " > p:nth-of-type(1)").innerText = "Nombre del archivo: " + archivo.name;
		    document.querySelector(seccionCampos + " > p:nth-of-type(2)").innerText = "Tamaño del archivo: " + archivo.size + " bytes";
		    document.querySelector(seccionCampos + " > p:nth-of-type(3)").innerText = "Tipo del archivo: " + archivo.type;
		    document.querySelector(seccionCampos + " > p:nth-of-type(4)").innerText = "Fecha de la última modificación: " + archivo.lastModifiedDate;
		    document.querySelector(seccionCampos + " > p:nth-of-type(5)").innerText = "Contenido del archivo de texto:";
