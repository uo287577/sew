...
document.write("<h3>Información principal</h3>");
document.write("<p>Nombre del pais: "+pais.getNombrePais()+"</p>");
document.write("<p>Nombre de la capital: "+pais.getNombreCapital()+"</p>");
document.write("</section>");
document.write("<section>");
document.write("<h3>Información secundaria</h3>");
document.write(pais.getInformacionSecundaria());
document.write("</section>");
document.write("<section>");
document.write("<h3>Coordenadas de la línea de meta del circuito</h3>");
