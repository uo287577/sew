...
class Semáforo
{
    ...
    createRecordForm(tiempo)
    {
        ...
        */
        ...
        campoNombre.append($("<span></span>"));
        var campoApellidos = $("<p>Introduzca sus apellidos: </p>").append($("<input type='text' name='apellidos' value='' >"));
        campoApellidos.append($("<span></span>"));
        var campoNivel = $("<p>Nivel del juego: </p>").append($("<input type='text' name='nivel' value='"+ this.#getCadenaDificultad() +"' readonly>"));
