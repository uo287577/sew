...
class Semáforo
{
    ...
    initSequence()
    {
        ...
        document.querySelector("body>main>section>button:nth-of-type(2)").setAttribute("disabled","true"); // asignamos el valor true al atributo disabled del botón de reacción del semáforo
