...
class Semáforo
{
    ...
    stopReaction()
    {
        /* Realiza las siguientes acciones, por orden:
            ...
            this.createRecordForm(diferencia * 1000); // llama al método que carga el formulario
    }
    ...
    createRecordForm(tiempo)
    {
        ...
        */
        ...
        var campoNombre = $("<p>Introduzca su nombre: </p>").append($("<input type='text' name='nombre' value='' >"));
        var campoApellidos = $("<p>Introduzca sus apellidos: </p>").append($("<input type='text' name='apellidos' value='' >"));
        var campoNivel = $("<p>Nivel del juego: </p>").append($("<input type='text' name='nivel' value='"+ this.#difficulty +"' readonly>"));
        var campoTiempo = $("<p>Tiempo de reacción: </p>").append($("<input type='text' name='tiempo' value='"+ tiempo +" segundos' readonly>"));
        ...
        $("main>section", document.body).append(form);
    }
}