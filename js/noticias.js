...
class Noticias
{
    constructor()
    {
        ...
        } else
        {
            ...
            document.querySelector("p > input").setAttribute("disabled","true");
        }
    }
    ...
    readInputFile(files)
    {
        ...
        var archivo = document.querySelector("p > input").files[0];
    ...
    añadirNoticia()
    {
        ...
        var titulo = document.querySelector(queryBase + " > p:nth-of-type(1) > input").value;
        var contenido = document.querySelector(queryBase + " > p:nth-of-type(2) > input").value;
        var autor = document.querySelector(queryBase + " > p:nth-of-type(3) > input").value;
