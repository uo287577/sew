...
class Memoria
{
    ...
    createElements()
    {
        ...
        for(var i = 0; i < this.elements.length; i++)
        {
            ...
            imagen.setAttribute("rel", "preconnect"); // le asignamos el valor preconnect al atributo rel para que la solicitud de la imagen se realice lo antes posible y así obtener un mayor rendimiento en la carga de la página
