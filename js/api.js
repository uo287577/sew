...
class Api
{
    ...
    cargarImagenMcLarenSenna(seccion)
    {
        ...
        source.setAttribute("srcset","multimedia/imagenes/" + nombreImagenACargar + "-465w.jpg");
        picture.appendChild(source);

        source = document.createElement("source");
        source.setAttribute("media","(max-width: 799px)");
        source.setAttribute("srcset","multimedia/imagenes/" + nombreImagenACargar + "-799w.jpg");
        picture.appendChild(source);

        source = document.createElement("source");
        source.setAttribute("media","(min-width: 800px)");
        source.setAttribute("srcset","multimedia/imagenes/" + nombreImagenACargar + ".jpg");
        picture.appendChild(source);

        var img = document.createElement("img");
        img.setAttribute("src","multimedia/imagenes/" + nombreImagenACargar + ".jpg");
